...
// the function of this component is the button of creating new posts
  ...
  handleOk = () => {
    ...
    this.postForm
      ...
      .then((form) => {
        ...
        if (postType) {
          // when transfering file between front-end and back-end, we have to use FormData()
          // 上产文件涉及到binary, we cannot use JSON
